...
├── reference-tables.md          ← Conditional conventions by input type (Swagger, Figma, transcripts)
├── workflows/
│   ├── 01-synthesize.md         ← Workflow 1: Context synthesis
│   ├── 02-generate.md           ← Workflow 2: Document generation (+ inline quality gate)
...
└── archive/
    ├── 02b-quality-gate.md       ← (archived — quality gate steps merged into 02-generate.md)
