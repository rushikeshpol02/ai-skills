...
2. **One skill at a time** — Complete each workflow file fully before reading the next

> For input-type conventions (Swagger, Figma, transcripts), see `reference-tables.md`.
...
**Core principle: Truth over completeness.** Mark unknowns as [TBD].
...
workflows/01-synthesize.md     → saves Context-Summary-[Feature].md
     ↓ reads
workflows/02-generate.md (+ inline quality gate)  → saves requirement doc(s)
     ↓ reads
...
**Read and follow:** `workflows/01-synthesize.md`
