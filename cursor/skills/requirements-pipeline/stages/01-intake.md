...
Before processing anything, ask the user for the output folder path (see **Output Folder & Artifact Registry** in SKILL.md). Create the `stage_output/` and `source_summaries/` subfolders.
